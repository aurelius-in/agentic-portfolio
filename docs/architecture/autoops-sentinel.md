...
sequenceDiagram
  ...
  DET-->>API: anomaly{svc,score,context}
...
* **Source:** [https://github.com/aurelius-in/AutoOps-Sentinel](https://github.com/aurelius-in/AutoOps-Sentinel)
* **Portfolio hub:** [https://github.com/aurelius-in/agentic-portfolio](https://github.com/aurelius-in/agentic-portfolio)

```

Want me to draft the Claims Triage one next in the same format?
